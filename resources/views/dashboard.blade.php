...
<div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-primary shadow h-100 py-2">
            ...
            <div class="col-auto text-center">
                    <a href="{{route('members.index')}}" class="btn btn-sm btn-icon-split btn-primary shadow-sm text-md font-weight-bold">
                        <span class="icon text-white-50">
                                <i class="fas fa-eye fa-sm"></i>
                        </span><span class="text"> See List</span></a>
                </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            ...
            <div class="col-auto text-center">
                <a href="{{route('members.index')}}" class="btn btn-sm btn-icon-split btn-success shadow-sm text-md font-weight-bold">
                    <span class="icon text-white-50">
                            <i class="fas fa-eye fa-sm"></i>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Birthdays</div>
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <i class="fas fa-cake fa-2x text-gray-300"></i>
                    </div>
                </div>
            </div>
            <div class="col-auto text-center">
                <a href="{{route('members.index')}}" class="btn btn-sm btn-icon-split btn-info shadow-sm text-md font-weight-bold">
                    <span class="icon text-white-50">
                            <i class="fas fa-eye fa-sm"></i>
...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            <!-- Card Header - Dropdown -->
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Social Trends</h6>
                <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">
                        <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
...
<div class="row">
    ...
    <div class="col-lg-6 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <h4 class="small font-weight-bold">Church Data Migration <span class="float-right">20%</span></h4>
